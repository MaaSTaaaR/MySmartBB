...
function my_strlen($string)
{
  ...
  // slurp all enabled feeds from the database
   	...
   	function copyright()
	{
	   global $PowerBB;
        $year = @date("Y");
    	$copy = 'Copyright ©' .$year.' هذا المنتدى يعمل على برنامج <a href="http://www.mysmartbb.com" rel="nofollow" target="_blank">MySmartBB</a> |&nbsp;إعداد و برمجة فريق MySmartBB';
		return $copy;
	}
  	...
  	function section_group_permission($forum_id, $group_id, $permission_name)
	{
	   ...
	   elseif(empty($Forum_rwo['sectiongroup_cache']))
	   {
